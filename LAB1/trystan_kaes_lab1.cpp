...
int main(){
  ...
  // std::cout << formatted << std::endl;
  std::cout << "Time spent in user mode   - " << epoch << "seconds" << std::endl; //output first integer
  ...
  // std::cout << formatted << std::endl;
  std::cout << "Time spent in system mode - " << epoch << "seconds" << std::endl; //output third integer
